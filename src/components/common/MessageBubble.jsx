/**
 * 🎯 Vistara UI - MessageBubble Component
 * "Command your Design."
 * 
 * Migrated from TitanMind with full CSS Variables support
 * Original: /Users/zvishilovitsky/TitanMind/dashboard/frontend/src/components/features/chat/ChatPanel/MessageBubble.jsx
 * 
  ...
  return (
    <div className={`vistara-component ${className || ''}`} style={containerStyles} {...props}>
      ...
      <div style={normalizeStyle({
        ...
        MessageBubble - Migrated to Vistara UI
      </div>
    </div>
  );
};
...
export default withNormalizedStyles(MessageBubble);