/**
 * 🎯 Vistara UI - TaskSummaryCompact Component
 * "Command your Design."
 * 
 * Migrated from TitanMind with full CSS Variables support
 * Original: /Users/zvishilovitsky/TitanMind/dashboard/frontend/src/components/features/tasks/TaskSummaryCompact/TaskSummaryCompact.jsx
 * 
  ...
  return (
    <div className={`vistara-component ${className || ''}`} style={containerStyles} {...props}>
      ...
      <div style={normalizeStyle({
        ...
        TaskSummaryCompact - Migrated to Vistara UI
      </div>
    </div>
  );
};
...
export default withNormalizedStyles(TaskSummaryCompact);